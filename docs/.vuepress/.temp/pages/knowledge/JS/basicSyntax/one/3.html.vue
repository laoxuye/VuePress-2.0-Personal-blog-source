<template><div><h1 id="类型转换" tabindex="-1"><a class="header-anchor" href="#类型转换" aria-hidden="true">#</a> 类型转换</h1>
<nav class="table-of-contents"><ul><li><router-link to="#基本规则">基本规则</router-link><ul><li><router-link to="#tostring">ToString</router-link></li><li><router-link to="#tonumber">ToNumber</router-link></li><li><router-link to="#toboolean">ToBoolean</router-link></li><li><router-link to="#toprimitive">ToPrimitive</router-link></li></ul></li><li><router-link to="#显式类型转换">显式类型转换</router-link></li><li><router-link to="#隐式类型转换">隐式类型转换</router-link><ul><li><router-link to="#运行环境">运行环境</router-link></li><li><router-link to="#运算符">运算符</router-link></li></ul></li></ul></nav>
<p>JavaScript 作为一种弱类型的语言，不用像 C 语言那样要定义好数据类型，因为允许变量类型的 隐式类型转换 和允许 强制类型转换。我们在定义一个变量的时候，只需一个 <code v-pre>var</code>、<code v-pre>let</code>、<code v-pre>const</code> 搞定，不用担心数据的类型。</p>
<h2 id="基本规则" tabindex="-1"><a class="header-anchor" href="#基本规则" aria-hidden="true">#</a> 基本规则</h2>
...
<li>Array 类型：转为字符串将各元素以小写逗号 , 连接，相当于调用数组 <code v-pre>Array.prototype.join()</code> 方法
<ul>
...
<div class="language-javascript line-numbers-mode" data-ext="js"><pre v-pre class="language-javascript"><code><span class="token function">String</span><span class="token punctuation">(</span><span class="token keyword">null</span><span class="token punctuation">)</span><span class="token punctuation">;</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="tonumber" tabindex="-1"><a class="header-anchor" href="#tonumber" aria-hidden="true">#</a> ToNumber</h3>
<ul>
...
<li>Array 类型：数组首先会被转为 <strong>原始数据类型</strong>，也就是 ToPrimitive，然后在根据转换后的原始类型按照上面的规则处理</li>
<li>对象：同数组的处理</li>
</ul>
<div class="language-javascript line-numbers-mode" data-ext="js"><pre v-pre class="language-javascript"><code><span class="token function">Number</span><span class="token punctuation">(</span><span class="token keyword">null</span><span class="token punctuation">)</span><span class="token punctuation">;</span>
...
<p>JavaScript 中假值只有 <code v-pre>false</code>、<code v-pre>null</code>、<code v-pre>undefined</code>、<code v-pre>&quot;&quot;</code>、<code v-pre>0</code> 和 <code v-pre>NaN</code>，其他值转为 Boolean 类型都为 <code v-pre>true</code>。</p>
<div class="language-javascript line-numbers-mode" data-ext="js"><pre v-pre class="language-javascript"><code><span class="token function">Boolean</span><span class="token punctuation">(</span><span class="token keyword">null</span><span class="token punctuation">)</span><span class="token punctuation">;</span>
...
<span class="token comment">// true</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="toprimitive" tabindex="-1"><a class="header-anchor" href="#toprimitive" aria-hidden="true">#</a> ToPrimitive</h3>
<blockquote>
<p>ToPrimitive 方法用于将引用类型转换为原始数据类型的操作</p>
</blockquote>
<p>当值为引用数据类型时，JavaScript 内置的 <code v-pre>@@ToPrimitive(hint)</code> 方法会被调用，以确定该值的最终目标类型。此方法接收一个 <code v-pre>hint</code> 参数，用于指示转换的方向，例如是否将该值转换为字符串或数字。通过使用 <code v-pre>@@ToPrimitive(hint)</code> 方法，JavaScript 可以保证在不同的类型间转换时的一致性和稳定性。</p>
<ul>
<li>如果传入值为 Number 类型，则调用对象的 <code v-pre>valueOf()</code> 方法，若返回值为原始数据类型，则结束 <code v-pre>@@ToPrimitive</code> 操作，如果返回的不是原始数据类型，则继续调用对象的 <code v-pre>toString()</code> 方法，若返回值为原始数据类型，则结束 <code v-pre>@@ToPrimitive</code> 操作，如果返回的还是引用数据类型，则抛出异常。</li>
<li>如果传入值为 String 类型，则先调用 <code v-pre>toString()</code> 方法，再调用 <code v-pre>valueOf()</code> 方法。</li>
</ul>
<div class="language-javascript line-numbers-mode" data-ext="js"><pre v-pre class="language-javascript"><code><span class="token punctuation">[</span><span class="token number">1</span><span class="token punctuation">,</span> <span class="token number">2</span><span class="token punctuation">]</span> <span class="token operator">==</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>对于不同类型的引用数据类型，ToPrimitive 的规则有所差异。例如，当处理 Date 对象时，该方法将会优先调用 toString() 方法。更详细的信息可以在 ECMAScript6 规范中对 ToPrimitive 的详细定义与解释中找到。在不同类型间转换时，了解 ToPrimitive 的规则是十分重要的，可以帮助我们更好地处理数据类型转换问题。</p>
<h2 id="显式类型转换" tabindex="-1"><a class="header-anchor" href="#显式类型转换" aria-hidden="true">#</a> 显式类型转换</h2>
<p>通过手动进行类型转换，JavaScript 提供了以下转型函数：</p>
<ul>
<li>转换为数值类型
<ul>
<li><code v-pre>Number(mix)</code></li>
<li><code v-pre>parseInt(string, radix)</code></li>
<li><code v-pre>parseFloat(string)</code></li>
</ul>
</li>
<li>转换为字符串类型
<ul>
<li><code v-pre>toString(radix)</code></li>
<li><code v-pre>String(mix)</code></li>
</ul>
</li>
<li>转换为布尔类型
<ul>
<li><code v-pre>Boolean(mix)</code></li>
</ul>
</li>
</ul>
<h2 id="隐式类型转换" tabindex="-1"><a class="header-anchor" href="#隐式类型转换" aria-hidden="true">#</a> 隐式类型转换</h2>
...
<tr>
<td>非 <code v-pre>!0</code> 数字</td>
<td><code v-pre>true</code></td>
</tr>
<tr>
<td>非空字符串 <code v-pre>!&quot;&quot;</code></td>
<td><code v-pre>true</code></td>
</tr>
<tr>
<td>非 <code v-pre>!null</code> 对象类型</td>
<td><code v-pre>true</code></td>
</tr>
</tbody>
</table>
<p>**注意事项：**使用 new 运算符创建的对象隐式转换为 Boolean 类型的值都是 <code v-pre>true</code>。</p>
<p>连续两个非操作可以将一个数强制转换为 Boolean 类型。</p>
<div class="language-javascript line-numbers-mode" data-ext="js"><pre v-pre class="language-javascript"><code><span class="token operator">!</span><span class="token operator">!</span><span class="token keyword">undefined</span><span class="token punctuation">;</span>
<span class="token comment">// false</span>
...
<span class="token comment">// true</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="运行环境" tabindex="-1"><a class="header-anchor" href="#运行环境" aria-hidden="true">#</a> 运行环境</h3>
<p>很多内置函数期望传入的参数的数据类型是固定的，如 <code v-pre>alert(value)</code>，它期望传入的 <code v-pre>value</code> 为 String 类型，但是如果我们传入的是 Number 类型或者 Object 类型等非 String 类型的数据的时候，就会发生数据类型的隐式转换。这就是环境运行环境对数据类型转换的影响。</p>
<p>类似的方法还有：</p>
<ul>
<li><code v-pre>alert()</code></li>
<li><code v-pre>parseInt()</code></li>
</ul>
<h3 id="运算符" tabindex="-1"><a class="header-anchor" href="#运算符" aria-hidden="true">#</a> 运算符</h3>
<h4 id="加号运算符" tabindex="-1"><a class="header-anchor" href="#加号运算符" aria-hidden="true">#</a> 加号运算符</h4>
<p>当加号运算符作为一元运算符运算值时，它会将该值转换为 Number 类型。</p>
<div class="language-javascript line-numbers-mode" data-ext="js"><pre v-pre class="language-javascript"><code><span class="token string">' '</span> <span class="token operator">+</span>
<span class="token comment">// 0</span>
...
<ul>
<li>字符串连接符：如果两个操作数中只要存在一个操作数为 String 类型，那么另一个操作数会调用 <code v-pre>String()</code> 方法转成字符串然后拼接</li>
<li>算术运算符：如果两个操作数都不是 String 类型，两个操作数会调用 <code v-pre>Number()</code> 方法隐式转换为 Number 类型（如果无法成功转换成数字，则变为 <code v-pre>NaN</code>，再往下操作），然后进行加法算术运算</li>
</ul>
<p>值转换为 Number 类型和 String 类型都会遵循一个原则：如果该值为原始数据类型，则直接转换为 String 类型或 Number 类型。如果该值为引用数据类型，那么先通过固定的方法将复杂值转换为原始数据类型，再转为 String 类型或 Number 类型。ToPrimitive</p>
<p>**注意事项：**当 <code v-pre>{} + 任何值</code> 时， 前一个 <code v-pre>{}</code> 都会被 JavaScript 解释成空块并忽略他。</p>
<div class="language-javascript line-numbers-mode" data-ext="js"><pre v-pre class="language-javascript"><code><span class="token string">"1"</span> <span class="token operator">+</span> <span class="token number">1</span>             <span class="token comment">// "11"</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="相等运算符" tabindex="-1"><a class="header-anchor" href="#相等运算符" aria-hidden="true">#</a> 相等运算符</h4>
...
<div class="language-javascript line-numbers-mode" data-ext="js"><pre v-pre class="language-javascript"><code><span class="token string">'1'</span> <span class="token operator">==</span> <span class="token boolean">true</span><span class="token punctuation">;</span> <span class="token comment">// true</span>
